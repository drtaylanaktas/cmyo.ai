            ...
            <div className="group relative flex items-center gap-3 px-4 py-1.5 rounded-full bg-slate-900/40 border border-slate-700/50 hover:bg-slate-800/60 hover:border-slate-600/50 transition-all duration-300">
              ...
              <div className="flex items-center gap-1.5">
                <svg viewBox="0 0 24 24" className="w-4 h-4 text-slate-300 group-hover:text-white transition-colors" fill="currentColor">
                  <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm1.68 14.88c-.68 0-1.4-.4-2.12-.4-.76 0-1.52.4-2.12.4-1.28.08-2.6-1.04-3.32-2.32-.88-1.52-1.36-3.76-.44-5.32.44-.76 1.16-1.28 2.04-1.28.72 0 1.4.48 1.84.48.48 0 1.24-.52 2.04-.52 1.04 0 1.88.44 2.36 1.12-2.04 1.24-1.68 4.2 1.04 5.32-.28.84-.76 1.6-1.32 2.52zM13.68 7.6c.4-.52.68-1.2.6-1.84-.56.04-1.28.4-1.68.88-.36.44-.68 1.12-.6 1.8.6.04 1.28-.36 1.68-.84z"/>
                </svg>
