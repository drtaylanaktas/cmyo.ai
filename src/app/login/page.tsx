                        ...
                        <div className="group relative flex items-center justify-center gap-3 px-5 py-2 rounded-full bg-slate-900/40 border border-slate-700/50 shadow-inner">
                            ...
                            <div className="flex items-center gap-1.5 relative z-10">
                                ...
                                <svg viewBox="0 0 24 24" className="w-4 h-4 text-green-500/80 group-hover:text-green-400 transition-colors" fill="currentColor">
                                    <path d="M17.523 15.3414c-.015-3.146-1.64-6.827-3.574-7.251l1.39-2.408c.196-.342.08-.778-.262-.974-.342-.196-.778-.08-.974.262L12.702 7.378C11.452 6.81 10.031 6.495 8.527 6.495c-1.503 0-2.924.316-4.174.883l-1.401-2.408c-.196-.342-.632-.458-.974-.262-.342.196-.459.632-.263.974l1.39 2.408C1.171 8.514-.454 12.195-.469 15.3414h17.992zm-8.318-3.414c-.724 0-1.312-.587-1.312-1.31 0-.724.588-1.312 1.312-1.312.724 0 1.312.588 1.312 1.312 0 .723-.588 1.31-1.312 1.31zm5.099 0c-.723 0-1.31-.587-1.31-1.31 0-.724.587-1.312 1.31-1.312.724 0 1.312.588 1.312 1.312 0 .723-.588 1.31-1.312 1.31zM6.155 6.945h11.69a6.007 6.007 0 0 0-11.69 0z"/>
                                </svg>
                            </div>
