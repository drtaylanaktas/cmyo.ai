                    ...
                    <div className="mt-8 flex flex-col items-center justify-center gap-3">
                        ...
                        <div className="group relative flex items-center justify-center gap-3 px-5 py-2 rounded-full bg-slate-900/40 border border-slate-700/50 shadow-inner">
                            ...
                            <div className="flex items-center gap-2 relative z-10">
                                <svg viewBox="0 0 384 512" className="h-[1.1rem] w-auto text-slate-300 group-hover:text-white transition-colors" fill="currentColor">
                                    <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 24 184.8 8 273.5q-10 53 15 107.5c17.5 38 43.5 76 81.5 73.5 36.5-2.5 50-22.5 91-22.5 41.5 0 54 22.5 92.5 21.5 40-1 65-42 81.5-73.5 21-41 29-79 29-79-37.5-16.5-60.3-43.5-60.3-84.8zM260.7 75.3c16.6-21.5 26.1-51.4 22.6-80.3-25.1 1.1-56.1 16.9-73.7 38.6-14.7 18.1-26.1 48.7-21.2 76.5 28.5 2.1 55.7-13.4 72.3-34.8z"/>
                                </svg>
